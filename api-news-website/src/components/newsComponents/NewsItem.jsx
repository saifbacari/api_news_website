      ...
      <CardNewsItem>
        <li>
          ...
          <div className={styles.textNewsItem}>
            <img src={`https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE%2CSIZE%2CURL&url=http://${website}&size=26`} alt={props.source.id}/>
            ...
            <a className={styles.url}>{props.url}</a>
